...
import { Menu, X, Zap, BookOpen, BarChart2, Home, Layers, FolderTree, Bell, Shield, Radio, Network, Settings, Wrench, FlaskConical, CreditCard, LayoutGrid, LogIn, LogOut , FileText, ChevronDown, Globe, Code2, Sliders, Server, LayoutDashboard, ScanSearch, GraduationCap, CheckCircle2 } from 'lucide-react'
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {showTraining && <TrainingModal course="opcua" onClose={() => setShowTraining(false)} />}
    </>
  )
}
