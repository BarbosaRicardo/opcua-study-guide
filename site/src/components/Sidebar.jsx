...
import { CheckCircle2, Circle, Menu, X, Network } from 'lucide-react'
...
export default function Sidebar() {
  ...
  const NavItem = ({ ch }) => {
    ...
    const path = CHAPTER_PATHS[ch.id] || `/${ch.id}`
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-5 border-b border-slate-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-navy-700 leading-tight">OPC UA</div>
      ...
      <div className="p-4 border-t border-slate-100 space-y-3">
        ...
        <p className="text-xs text-slate-400 text-center leading-relaxed">
          ...
          <span className="text-mblue-400">OPC UA Protocol · May 2026</span>
        </p>
      </div>
    </div>
  )
