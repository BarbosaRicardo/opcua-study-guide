...
import { ChevronLeft, ChevronRight, BookOpen, Home, Layers, FolderTree, Bell, Shield, Radio, Network, Settings, Wrench, FlaskConical, CreditCard } from 'lucide-react'
...
export default function ChapterLayout({ chapterId, title, children, prev, next }) {
  ...
  return (
    ...
    >
      {/* Chapter header */}
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm font-medium mb-3" style={{ color: 'rgba(13,148,136,0.75)' }}>
        ...
        <div className="mt-4 h-px" style={{ background: 'linear-gradient(90deg, rgba(13,148,136,0.8), rgba(15,118,110,0.4), transparent)' }} />
      </div>
