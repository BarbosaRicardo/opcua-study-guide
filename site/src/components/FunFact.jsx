...
import { Lightbulb, RefreshCw, Layers, AlertTriangle, Hash, LockOpen, Flame, Radio, Zap, Settings, Shield, Wrench, AlertOctagon } from 'lucide-react'
import { FUN_FACTS } from '../data/chapters'

const ICON_MAP = {
  Layers, AlertTriangle, Hash, LockOpen, Flame, Radio, Zap, Settings, Shield, Wrench, AlertOctagon,
}
