...
const STORAGE_KEY = 'opcua_progress_v1'
const PROGRESS_EVENT = 'opcua_progress_update'
...
export function useProgress() {
  ...
  const overallProgress = () => {
    const chapters = ['intro', 'architecture', 'infomodel', 'services', 'security', 'subscriptions', 'transport', 'ignition', 'troubleshoot', 'lab']
